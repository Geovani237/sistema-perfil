                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="fundo1">
                                Imagem de fundo 01
                                <img src="img/fundo1.jpg" class="img-fluid">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="fundo2">
                                Imagem de fundo 02
                                <img src="img/fundo2.jpg" class="img-fluid">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="fundo3">
                                Imagem de fundo 03
                                <img src="img/fundo3.jpg" class="img-fluid">
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="fundo4">
                                Imagem de fundo 04
                                <img src="img/fundo4.jpg" class="img-fluid">
                            </label>
                        </div>
                    </div>
